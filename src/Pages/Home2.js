      ...
      <main>
        ...
        <section className="sec2">
          ...
          <div className="sec2_d2">
            <div className='sec2_d'>
              <img src={"./Icons/Support.png"} alt="" />
              <h4 className='sec2_h4'>
                <b>Costom Hardware</b>
              </h4>
              <p className='sec2_p'>
        ...
        <section className="sec8">
          <div className="bg-black sec8_d1">
            <p>
        ...
        <section className="sec11">
          <h2 className='sec11_h2'><b>Why choose Larvasoft?</b></h2>
  ...
  <section className="scroll-container">
    <div className="scroll-element js-scroll slide-right"><div className="card-body">
      <h2 className="card-title">Collaboration<img src={"./Icons/People.png"} alt="" /></h2></div>
         <p className="card-text">Your vision are essitial to us .WE belive transparent communation and Collaboration thoughout the development process.</p>
     </div>
  </section>
  ...
  <section className="scroll-container">
    <div className="scroll-element js-scroll slide-left"><div className="card-body">
      <h2 className="card-title"><img src={"./Icons/Business Group.png"} alt="" />Experienced Team</h2></div>
         <p className="card-text">Our team comprises of skilled developers, disgners, and the strategists with years of industrial experience.</p>
     </div>
  </section> 
  </div>
  </section>
