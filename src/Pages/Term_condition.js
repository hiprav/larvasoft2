...
export default function Term_condition() {
  return (
    <div>
      ...
      <a href="Terms+&+Conditions.pdf " className="material-symbols-outlined" download="Larvasoft">download</a>

      <span  className="dot11"></span>
      <span  className="dot2"></span> <br/>
      <h1 className='heading'>Terms & Conditions</h1>
      <h3 className='head'>The following definitions shall apply for the scope of these Terms: </h3>
      <h4 className='head'>Access to Managed Services is granted for the particular License Terms. </h4>
      <p className='head'>Should a Product of Larvasoft Tech Apps be provided to the Customer pursuant to a license which, when fully
paid, is to be perpetual, the following shall apply: </p>
<div className="_ngcontent">
          <h3 className="_ngcontent">
          ...
          applicable in addition to these Terms. In case of conflict between
          ...
          agreed to customer's terms and conditions in www.larvasoft.com. These
          Terms also apply in cases where Larvasoft Tech Apps provides its
          ...
          Customer may object to the changes. If the Customer does not object to
          the changes or any part thereof, within four (4) weeks after receipt
          of a notification (hereinafter referred to as "Objection Period"), the
          ...
          the agreement will continue on the present Terms or Larvasoft Tech
          Apps may, in its discretion terminate any or all licenses or other
        ...
        <div className="_ngcontent">
          ...
          <br />
          <br />
          <b className="color-green">INTERNET</b>
          - We use INTERNET permission to use the internet only.
          <br />
          <br />
          <b className="color-green">LOCATION</b>
          ...
          <br />
          <br />
          <b className="color-green">PHONE_STATE</b>
          ...
          <br />
          <br />
          <b className="color-green">CONTACTS</b>
          - This permission is required for Parent to see their Child’s App
          ...
          <br />
          <br />
          <b className="color-green">SMS </b>- This permission is required to
          help Parent to retrieve their Child's location for safety needs or in
          case of theft. We don't collect or share this information with anyone
          run smoothly without being interrupted by battery.
          <br />
          <br />
        ...
        <div className="_ngcontent">
          <h3 className="_ngcontent">Definitions</h3>
          <br />
          <br />
          ...
          <br />
          <br />
          <b className="color-green">Automatic Renewal</b>
          - means renewal of a License at the end of a License Term without
          added notice. Larvasoft Tech.
          <br />
          <br />
          <b className="color-green">Apps Freeware</b> - means any and all
          Products and Services that are provided to the Customer free of
          charge.
          <br />
          <br />
          <b className="color-green">Larvasoft Tech Apps Shareware</b>
          ...
          <br />
          <br />
          <b className="color-green">Computer</b>
          - means any device that is able to process data with the assistance of
          a programmable calculation specification.
          <br />
          <br />
          <b className="color-green">Consumer</b> - means a Consumer and/or
          Entrepreneur.
          <br />
          <br />
          <b className="color-green">Entrepreneur</b> - means any natural
          person, partnership, corporation, Limited Liability Company or other
          legal business entity that uses the Products or Services of Larvasoft
          Tech Apps in their or its business and is not using the Products or
          Services for personal or family reasons.
          <br />
          <br />
          <b className="color-green">EULA</b>
          - means the End User License Agreement of the respective Larvasoft
          Tech Apps entity that must be accepted by the Customer before any use
          of the Products. I (users) agree all the terms and conditions with
          Larvasoft apps. Larvasoft Tech provides lot of various different
          applications, Apps purpose is for safety and entertainment purpose
          only. If any misuse will happened through any apps of Larvasoft Tech
          then i agree on that i will be only responsible. Larvasoft Tech team
          will not be responsible directly or indirectly. I am also responsible
          for my data storage and lost of data, Larvasoft Tech team are not
          responsible for that. Larvasoft Tech’s IOS application has limited
          features only as provided by the Apple guidelines and IOS limitations
          in software architecture. Customer or end users having not any rights
          to claim for same features in both IOS and Android Operating system.
          Larvasoft Tech’s Android and IOS having different features totally
        ...
        <div className="_ngcontent">
          ...
          <br />
          <br />
          <b className="color-green">License</b>
          - means the Customer's right to use the Products or Services subject
          to these Terms and in accordance with the EULA or SLA in effect as at
          ...
          <br />
          <br />
          <b className="color-green">License Term</b>
          - means the time period for which Larvasoft Tech Apps has granted
          Customer a License to a Product or Service and, if applicable to
          receive Updates and Upgrades. The License Term commences as soon as
          the Customer has received a Software Key or Login.
          <br />
          <br />
          <b className="color-green">License Term</b> - means entering of
          identifier information into a Managed Service by a Customer in order
        ...
        <div className="_ngcontent">
          ...
          <br />
          <br />
          <b className="color-green">Managed Service</b>
          ...
          <br />
          <br />
          <b className="color-green">Multiple Use</b>
        ...
        <div className="_ngcontent">
          ...
          access to Updates/Upgrades. The Software Key is an integral component
        ...
        <div className="_ngcontent">
          ...
          Larvasoft Tech Apps. Some Software requires the Update Service for
          ...
          only and shall not provide an express or implied warranty nor any
        ...
        <div className="_ngcontent">
          <h3 className="_ngcontent">Subject matter of Agreements</h3>
          ...
          possibly not compatible with operating systems that are not specified
        ...
        <div className="_ngcontent">
          ...
          agreement. In particular, the Software must not be reproduced,
          transferred or decompiled (i.e. recompilation into the source code),
          unless expressly permitted by the EULA or permitted according to law.
          If the Customer wishes to reverse engineer, decompile or disassemble
          the Software (hereinafter referred to as "De-compilation") for the
          purpose of achieving interoperability with other computer programs if
          allowed by law, the Customer shall contact Larvasoft Tech Apps before
          ...
          interoperability without undue delay, the Customer shall not be
          entitled to decompile the Software. Software for which no special
          Licenses for Multiple Use are available according to the relevant
          product information is restricted to use on one Computer by a
          Customer. For this purpose, the Customer may use any available
          Computer that meets the system requirements and for which the License
          was granted. Should the Customer change the Computer, the Software
          must be deleted from the Computer on which the Software was previously
          installed before the reinstallation of the Software on a different
          Computer. For Software whose product information provides special
          ...
          rights to bring an action to prohibit or stop any unauthorized use of
          Products and/or Services by the Customer, including but not limited
          to, claims for injunctive relief and damages. Unauthorized use by the
          Customer may lead to criminal prosecution under the relevant laws.
          Reference is also made to the supplementary terms and conditions of
          use under the applicable EULA and/or the SLA. Special provisions for
          Resellers If Products and/or Services are provided to a Reseller, the
          ...
          an SLA. The Reseller shall not reproduce the Products and/or Services
          in whole or in part, including for purposes of data backup. The
          parties acknowledge that damages resulting from a breach of this
          clause by Reseller are difficult to determine and/or quantify.
          Therefore, for each breach of the foregoing provisions of this clause
          5, and without prejudice to Larvasoft Tech Application’s right to seek
          other remedies at law or in equity the Reseller shall pay to Larvasoft
          Tech Apps liquidated damages in the amount of USD 20,000. Additional
          claims by Larvasoft Tech Apps resulting from the breach of these
          ...
          Reseller are difficult to determine and/or quantify. Therefore, for
          each breach of the foregoing provisions of this clause 5, and without
        ...
        <div className="_ngcontent">
          ...
          between the parties in www.larvasoft.com. Larvasoft Tech Apps may
          render partial deliveries where a partial delivery is reasonable for
          the Customer and does not significantly impair the Customer's
          interests. Deviations of the delivered Products and/or Services from
          ...
          adversely affected. Larvasoft Tech Apps reserves the right to make
          ...
          technical changes to the Products and/or Services which enhance their
          operability and performance or which are necessary for the operability
          of the Products and/or Services. Should Products and/or Services
          licensed by Customer be replaced by new Products and/or Services in
          Larvasoft Tech Application’s product line, and such new Products
          and/or Services perform as well or better than the Products and/or
          Services ordered by Customer, then Larvasoft Tech Apps has Deviations
          of the delivered Products and/or Services from documentation shall be
          permitted provided that they are reasonable and that the performance
          of the Products or Services is not materially, adversely affected.
          Larvasoft Tech Apps reserves the right to make technical changes to
          ...
          than the Products and/or Services ordered by Customer, then Larvasoft
          Tech Apps has the right to deliver such new Products and/or Services
          instead of the ordered Products Should Products and/or Services
          licensed by Customer be replaced by new Products and/or Services in
          Larvasoft Tech Application’s product line, and such new Products
          and/or Services perform as well or better than the Products and/or
          Services ordered by Customer, then Larvasoft Tech Apps has Deviations
          ...
          than the Products and/or Services ordered by Customer, then Larvasoft
          Tech Apps has the right to deliver such new Products and/or Services
          instead of the ordered Products and/or Services. Should Products
          and/or Services of Larvasoft Tech Apps be shipped at the Customer's
          request, the risk for damage and loss shall pass to the Customer upon
          ...
          no less than three weeks set by the Customer. Should Larvasoft Tech
          Apps be in default of its delivery obligations or should delivery
          become impossible for Larvasoft Tech Apps, Larvasoft Tech Apps shall
          only be liable pursuant to clauses 10 and 11 below. If timely delivery
          is prevented by circumstances that are not just temporary and that do
          not fall within Larvasoft Tech Application’s control (in particular,
          in the event of strike, lock-out, unavailability of materials, force
          majeure, transport hindrances, plant closures or unavailability of
        ...
        <div className="_ngcontent">
          ...
          not give rise to any costs and fees for Larvasoft Tech Apps. If the
          Customer defaults in payments, Larvasoft Tech Apps may demand agreed
          upon or statutory default interest for all past due sums without
          further notice. Payments shall be due immediately without any
          deductions. Bills of exchange and checks shall be accepted by
        ...
        <div className="_ngcontent">
          ...
          based on the same legal relationship between the parties. Customer
          should carefully note the consequences of a failure to install
        ...
        <div className="_ngcontent">
          ...
          Customer. If the Customer has not installed the current
          Updates/Upgrades of Larvasoft Tech Apps, the Software's protection
          against computer viruses and other Malware may be materially impaired.
          ...
          or potential defects in the The Customer shall promptly notify
          Larvasoft Tech Apps of any alleged or potential defects in the
          Products and/or Services provided. The Customer shall notify Larvasoft
          Tech Apps without undue delay of any changes to its email address or
          contact information in order for Larvasoft Tech Apps to be able to
          send the Customer security-relevant information for the use of the
          ...
          notification. The Customer shall promptly notify Larvasoft Tech Apps
          of any alleged or potential defects in the Products and/or Services
          provided. The Customer shall notify Larvasoft Tech Apps without undue
          delay of any changes to its email address or contact information in
          order for Larvasoft Tech Apps to The Customer shall promptly notify
          Larvasoft Tech Apps of any alleged or potential defects in the
          Products and/or Services provided. The Customer shall notify Larvasoft
          Tech Apps without undue delay of any changes to its email address or
          contact information in order for Larvasoft Tech Apps to be able to
        ...
        <div className="_ngcontent">
          ...
          provided by Larvasoft Tech Apps, including that in the user handbooks.
          Larvasoft Tech Apps does not warrant that the Products and Services
          under the agreement will be fit for any particular purpose. The
          Customer is advised and understands that, based on the current state
          of the art, technology program errors cannot be excluded from a
          Software Product or Service with complete certainty and that it is not
          possible to develop Software or Services that detect The Customer is
          advised and understands that, based on the current state of the art,
          technology program errors cannot be excluded from a Software Product
          or Service with complete certainty and that it is not possible to
          develop Software or Services that detect The Customer is advised and
          understands that, based on the current state of the art, technology
          program errors cannot be excluded from a Software Product or Service
          with complete certainty and that it is not possible to develop
          ...
          permanent operation of systems and in which the failure of the
          Products may result in harm to an individual’s life, body or health or
          in substantial damage to property or the environment (such as high
          risk activities and high availability activities, including but not
          limited to the operation of nuclear facilities, weapon systems,
          ...
          with the Product pursuant to a perpetual, fully paid license, then
          defects in the provided Products, shall be rectified by Larvasoft Tech
          Apps, as follows, provided the Customer has notified Larvasoft Tech
          Apps of the respective defect promptly Notified errors shall be
          rectified by Larvasoft Tech Apps choice If the Customer is an
          Entrepreneur and Larvasoft Tech Apps has provided the Customer with
          the Product pursuant to a perpetual, fully paid license, then defects
          in the provided Products, shall be rectified by Larvasoft Tech Apps,
          as follows, provided the Customer has notified Larvasoft Tech Apps of
          ...
          or provision of an error-free Product ("substitute If the Customer is
          an Entrepreneur and Larvasoft Tech Apps has provided the Customer with
          the Product pursuant to a perpetual, fully paid license, then defects
          in the provided Products, shall be rectified by Larvasoft Tech Apps,
          as follows, provided the Customer has notified Larvasoft Tech Apps of
          the respective defect promptly Notified errors shall be rectified by
        ...
        <div className="_ngcontent">
          ...
          rectified by Larvasoft Tech Apps, as follows, provided the Customer
          has notified Larvasoft Tech Apps of the respective defect promptly
          Notified errors shall be rectified by Larvasoft Tech Apps choice
          ...
          clause 11. If Larvasoft Tech Apps has provided a Customer with the
          Product pursuant to a fully paid license for a specific term, for one
          ...
          or if repair and substitute delivery fail for other reasons, then the
          Customer may, at its choice, reduce the Fee paid to Larvasoft Tech
          Apps pro rata or - if the defects are not immaterial - terminate the
          agreement. Any damage claims of a Customer or claims for expenses
          incurred that arise from such defects shall be governed exclusively by
        ...
        <div className="_ngcontent">
          ...
          repair or substitution was unjustifiably refused by Larvasoft Tech
          Apps. If rectification of a defect in the form of repair or subsequent
          ...
          afford the Customer to its right to rescind or terminate the
          agreement. No warranty is provided for Larvasoft Tech Apps Freeware or
          ...
          Larvasoft Tech Apps Freeware or other Products and/or Services
          provided by Larvasoft Tech Apps free of charge, except for the
          operability of the Computer Program hereinafter. The same shall apply
          for Larvasoft Tech Apps Shareware, as long as there is no agreement
          with the Customer for the unconditional provision of a Software Key or
          Login No warranty is provided for Larvasoft Tech Apps Freeware or
          other Products and/or Services provided by Larvasoft Tech Apps free of
          charge, except for the operability of the Computer Program
          hereinafter.
          <br className="_ngcontent" />
          ...
          shall any Customer ever be entitled to access, or demand access to the
          source code for the Software and/or Managed Services. The Customer
